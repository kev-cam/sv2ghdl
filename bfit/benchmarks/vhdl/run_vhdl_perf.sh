...
echo "and the fork now LEADS stock on SEVEN of eight rows (b17 +19%, b12 +14%,"
echo "b22 +7%, b14 +6%, bench_comb, b01, b06) with fused dispatch default-on and"
echo "the native projection complete: \`bench_comb\`"
...
echo "The sole holdout: bench_seq 1.09x — 45 lines, 5 processes, the smallest"
echo "possible scheduler footprint, where stock's flat 1.22 scheduler/MIR core"
echo "(the non-cherry-pickable four-release gap) still shows."
echo
