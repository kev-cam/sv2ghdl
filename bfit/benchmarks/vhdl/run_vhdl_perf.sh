...
echo "and on the two largest ITC designs the fork now LEADS stock: \`bench_comb\`"
...
echo "misses −46%) pushed b12 and b17 PAST stock. The residual few percent"
echo "elsewhere is scheduler/MIR-level divergence, not a single hot spot."
echo
