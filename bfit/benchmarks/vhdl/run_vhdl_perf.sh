...
echo "and the fork now LEADS stock on SEVEN of eight rows (b17 +18%, b12 +17%,"
echo "b22 +9%, bench_comb +8%, b14 +5%, b01, b06) with fused dispatch default-on"
echo "and the native projection complete: \`bench_comb\`"
...
echo "non-cherry-pickable four-release gap)."
echo
